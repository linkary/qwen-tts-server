export const en = {
  ...
  apiKeyFetching: 'Fetching...',
  apiKeyFetched: 'API key loaded from server',
  apiKeyFetchFailed: 'Could not fetch the API key',
  apiKeyFetchUnavailable: 'This server does not expose its API key',
  apiKeyAuthDisabled: 'This server has no authentication configured',
